  ...
  <?php foreach ($courses as $c): ?>
    <div class="card" style="display:flex;justify-content:space-between;align-items:center;">
      <div>
        ...
        <?php 
            $classCountStmt = $pdo->prepare("SELECT COUNT(*) FROM classes WHERE course_id = ?");
            $classCountStmt->execute([$c['course_id']]);
            $classCount = $classCountStmt->fetchColumn();
        ?>
        <div class="meta">Tersedia <?= $classCount ?> Kelas</div>
      </div>
